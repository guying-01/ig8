    ...
    <div class="igb-audio-family-control-base-component">
        ...
        <div class="foo-controller">
            ...
            <div class="player-controller">
                ...
                <div class="contr contr-next" id="reference-contr-cut">
                    <i></i>
                </div>
            </div>
            <!--音量控制-->
            <div class="volume-controller">
                <div class="contr contr-vom" id="refrence-contr-nov">
                    <i></i>
                </div>
                <div class="contr contr-vom-slider">
                    <a-slider
                        ...
                        :defaultValue="0.5"
                        :tipFormatter="null"
                        @change="volumeHandller"
                    />
                </div>
            </div>
            <!--歌曲控制-->
            <div class="song-controller">
                <div class="contr contr-cc" id="reference-contr-reset">
                    <i></i><span>重唱</span>
                </div>
                ...
                <div class="contr contr-xh" id="refrence-contr-xh">
                    <i></i><span>循环</span>
                </div>
                <div
                ...
                >
                    ...
                    <transition name="pull-up">
                        <igb-order-list
                            ...
                            v-if="visible"
                             v-clickoutside="closeOrderListHandler"
                        ></igb-order-list>
                    </transition>
                </div>
            </div>
...
export default {
  ...
  methods: {
    ...
    closeOrderListHandller (evt) {
      let ktvCtrlEl = document.querySelector('.igb-audio-family-control-base-component')
    ...
    .foo-controller {
        ...
        .player-controller {
            ...
            .contr-play {
                ...
                i {
                    background: url("../../../assets/images/p/play-start.png")
                        no-repeat center center;
                    background-size: calc-attr(60) calc-attr(60);

                    &:hover {
                        background: url("../../../assets/images/p/play-start-hover.png")
                            no-repeat center center;
                        background-size: 100%;
            ...
            .contr-pause {
                ...
                i {
                    background: url("../../../assets/images/p/play-end.png")
                        no-repeat center;
                    background-size: calc-attr(60) calc-attr(60);

                    &:hover {
                        background: url("../../../assets/images/p/play-end-hover.png")
                            no-repeat center;
                        background-size: 100%;
                    }
                }
            ...
            .contr-next {
                ...
                i {
                    width: calc-attr(55);
                    height: calc-attr(56);
                    background: url("../../../assets/images/p/play-right.png")
                        no-repeat center center;
                    background-size: calc-attr(17.39) calc-attr(19.24);

                    &:hover {
                        //box-shadow: 0px 0px calc-attr(18) rgba(255, 136, 56, 0.45);
                        background: url("../../../assets/images/p/play-right-hover.png")
                            no-repeat center center;
                        background-size: 100%;
                    }
                }
        ...
        .volume-controller {
            ...
            .contr-vom {
                ...
                i {
                    ...
                    width: calc-attr(24);
                    height: calc-attr(24);
                    background: url("../../../assets/images/p/play-yinliang.png")
                        no-repeat center;
                    background-size: calc-attr(22) calc-attr(23.33);

                    &:hover {
                        background: url("../../../assets/images/p/play-yinliang-hover.png")
                            no-repeat center;
                        background-size: calc-attr(22) calc-attr(23.33);
                    }
                }
        ...
        .song-controller {
            ...
            .contr-cc {
                ...
                i {
                    width: calc-attr(36);
                    background: url("../../../assets/images/p/play-cc.png")
                        no-repeat center center;
                    background-size: 100%;
                }
                ...
                &:hover {
                    i {
                        background: url("../../../assets/images/p/play-cc-h.png")
                            no-repeat center center;
                        background-size: 100%;
                    }
            ...
            .contr-ly {
                ...
                i {
                    width: calc-attr(36);
                    background: url("../../../assets/images/p/play-ly.png")
                        no-repeat center center;
                    background-size: 100%;
                }
                ...
                &:hover {
                    i {
                        background: url("../../../assets/images/p/play-ly-h.png")
                            no-repeat center center;
                        background-size: 100%;
                    }
            ...
            .contr-sc {
                ...
                i {
                    width: calc-attr(36);
                    background: url("../../../assets/images/p/play-sc.png")
                        no-repeat center center;
                    background-size: 100%;
                }
                ...
                &:hover {
                    i {
                        background: url("../../../assets/images/p/play-sc-h.png")
                            no-repeat center center;
                        background-size: 100%;
                    }
            ...
            .contr-xh {
                ...
                i {
                    width: calc-attr(36);
                    background: url("../../../assets/images/p/play-xh.png")
                        no-repeat center center;
                    background-size: 100%;
                }
                ...
                &:hover {
                    i {
                        background: url("../../../assets/images/p/play-xh-h.png")
                            no-repeat center center;
                        background-size: 100%;
                    }
            ...
            .contr-yd {
                ...
                i {
                    width: calc-attr(36);
                    background: url("../../../assets/images/p/play-yd.png")
                        no-repeat center center;
                    background-size: 100%;
                }
                ...
                &:hover {
                    i {
                        background: url("../../../assets/images/p/play-yd-h.png")
                            no-repeat center center;
                        background-size: 100%;
                    }
        ...
        .song-switch {
            ...
            .btn-switch {
                ...
                &.btn-switch-on {
                    ...
                    &:hover {
                        box-shadow: 0px 0px calc-attr(18)
                            rgba(255, 136, 56, 0.16);
