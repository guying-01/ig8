...
<div class="igb-pages-user">
    <igb-page-main title="设置个人信息">
        <template slot="main">
            <div class="main">
                <div class="form-list">
                    <div class="form-list-item form-list-item-lig" style="padding-bottom:46px">
                    ...
                    <div class="form-list-item" style="padding-bottom:29px">
                        <div>用户类型</div>
                        <div>
                    ...
                    <div class="form-list-item form-list-item-lig" style="padding-bottom:29px">
                        <div>会所介绍</div>
                        <div>
                    ...
                    <div class="form-list-item" style="padding-bottom:134px">
                        <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
                        <div>
