...
<div class="igb-song-card-list-base-component">
    <div v-if="showType" class="song-card-list-item item-first" :class="`item-first-${type}`">
        <div class="item-box">

        </div>
    </div>
    <div class="song-card-list-item" v-for="(item,index) in dataSource" :key="index" :class="{'current':item.current,'play':item.play}" @click="changeHandller(item);">
        <div class="item-box" :class="{'item-box-not-num':!showNum}">
            ...
            <div class="info">
                <h3>{{item.label}}</h3>
                <p><span>{{item.name}}</span><span>|</span>{{item.lan}}</p>
    ...
    >div {
        ...
        &.item-first-0 {
            ...
            .item-box {
                ...
                background: url("../../../assets/images/xingepaihangbang.png") no-repeat center;
                background-size: 100%;
            }
        }
            ...
            .item-box {
                ...
                .info {
                    ...
                    .icon-collect {
                        ...
                        &:hover {
                            background: url("../../../assets/images/icon1_hover.png") no-repeat center;
                            background-size: 100%;
                            opacity: 1;
                        }
                    }
