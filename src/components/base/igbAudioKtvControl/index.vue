...
<div class="igb-audio-ktv-control-base-component">
    ...
    <div class="foo-controller">
        ...
        <div class="player-controller">
            <div class="contr contr-play" :class="{'contr-pause':isPlay}" @click="playHandller"><i></i><span>播放</span></div>
        ...
        .player-controller {
            ...
            .contr-play {
                i {
                    width: 19.77px;
                    height: 27px;
                    background: url("../../../assets/images/k/k-play.png") no-repeat center center;
                    background-size: 100%;
                }

                &:hover {
                    i {
                        background: url("../../../assets/images/k/k-play-h.png") no-repeat center center;
                        background-size: 100%;
                    }
                }
            }
            ...
            .contr-pause {
                i {
                    width: 19.77px;
                    height: 27px;
                    background: url("../../../assets/images/k/k-pause.png") no-repeat center center;
                    background-size: 100%;
                }
            ...
            .contr-reset {
                i {
                    width: 24.82px;
                    height: 27px;
                    background: url("../../../assets/images/k/k-reset.png") no-repeat center;
                    background-size: 100%;
                }

                &:hover {
                    i {
                        background: url("../../../assets/images/k/k-reset-h.png") no-repeat center center;
                        background-size: 100%;
                    }
                }
            }
            ...
            .contr-cut {
                ...
                &:hover {
                    i {
                        background: url("../../../assets/images/k/k-cut-h.png") no-repeat center center;
                        background-size: 100%;
                    }
                }
            }
        ...
        .volume-controller {
            ...
            .contr-nov {
                i {
                    width: 26.44px;
                    height: 27px;
                    background: url("../../../assets/images/k/k-nov.png") no-repeat center center;
                    background-size: 100%;
                }

                &:hover {
                    i {
                        background: url("../../../assets/images/k/k-nov-h.png") no-repeat center center;
                        background-size: 100%;
                    }
                }
            }
            ...
            .contr-ova {
                ...
                &:hover {
                    i {
                        background: url("../../../assets/images/k/k-ova-h.png") no-repeat center center;
                        background-size: 100%;
                    }
                }
            }
            ...
            .contr-ovd {
                ...
                &:hover {
                    i {
                        background: url("../../../assets/images/k/k-ovd-h.png") no-repeat center center;
                        background-size: 100%;
                    }
                }
            }
        ...
        .song-controller {
            ...
            .contr-ly {
                i {
                    width: 26.97px;
                    height: 27px;
                    background: url("../../../assets/images/k/k-ly.png") no-repeat center center;
                    background-size: 100%;
                }

                &:hover {
                    i {
                        background: url("../../../assets/images/k/k-ly-h.png") no-repeat center center;
                        background-size: 100%;
                    }
                }
            }
            ...
            .contr-sc {
                ...
                &:hover {
                    i {
                        background: url("../../../assets/images/k/k-sc-h.png") no-repeat center center;
                        background-size: 100%;
                    }
                }
            }
            ...
            .contr-qf {
                ...
                &:hover {
                    i {
                        background: url("../../../assets/images/k/k-qf-h.png") no-repeat center center;
                        background-size: 100%;
                    }
                }
            }
            ...
            .contr-yd {
                ...
                &:hover {
                    i {
                        background: url("../../../assets/images/k/k-yd-h.png") no-repeat center center;
                        background-size: 100%;
                    }
                }
            }
